...
void Classifier::ProcessGate(MPCPGate *gt) {
    ...
    ///*
	//LogResults checkAi("ONUAi_ONU16");
	//if(getParentModule()->getId() - 2 == 16 && simTime() > 3) {
	//    checkAi << " reportCycles : " << reportCycles << " actualAi : " << actualAi << endl;
	//}

	//LogResults checkAi2("ONUAi_ONU02");
	//if(getParentModule()->getId() - 2 == 2 && simTime() > 3) {
	//    checkAi2 << " reportCycles : " << reportCycles << " actualAi : " << actualAi << endl;
	//}
    /*
	LogResults checkAi4("ONUAi_ONU04");
	if(getParentModule()->getId() - 2 == 4 && simTime() > 3) {
	    checkAi4 << " reportCycles : " << reportCycles << " actualAi : " << actualAi << endl;
	}

	LogResults checkAi6("ONUAi_ONU06");
	if(getParentModule()->getId() - 2 == 6 && simTime() > 3) {
	    checkAi6 << " reportCycles : " << reportCycles << " actualAi : " << actualAi << endl;
	}
	*/
	/*
    LogResults checkAi8("ONUAi_ONU08");
    if(getParentModule()->getId() - 2 == 8 && simTime() > 3) {
        checkAi8 << " reportCycles : " << reportCycles << " actualAi : " << actualAi << endl;
    }

    LogResults checkAi10("ONUAi_ONU10");
    if(getParentModule()->getId() - 2 == 10 && simTime() > 3) {
        checkAi10 << " reportCycles : " << reportCycles << " actualAi : " << actualAi << endl;
    }

    LogResults checkAi12("ONUAi_ONU12");
    if(getParentModule()->getId() - 2 == 12 && simTime() > 3) {
        checkAi12 << " reportCycles : " << reportCycles << " actualAi : " << actualAi << endl;
    }

    LogResults checkAi14("ONUAi_ONU14");
    if(getParentModule()->getId() - 2 == 14 && simTime() > 3) {
        checkAi14 << " reportCycles : " << reportCycles << " actualAi : " << actualAi << endl;
    }

    LogResults checkAi18("ONUAi_ONU18");
    if(getParentModule()->getId() - 2 == 18 && simTime() > 3) {
        checkAi4 << " reportCycles : " << reportCycles << " actualAi : " << actualAi << endl;
    }
    */
	//
